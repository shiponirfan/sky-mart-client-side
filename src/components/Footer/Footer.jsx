    ...
    <footer className="bg-job-secondary  dark:bg-gray-900">
      <div className="mx-auto container pb-6 pt-16 px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="xl:max-w-[300px] lg:max-w-[180px] max-w-[250px] mx-auto lg:mx-0">
              <img
                className="w-full"
            ...
            <p className="mt-6 lg:max-w-md text-center leading-relaxed text-gray-500 dark:text-white  lg:text-left">
              ...
              accessories. Elevate your style with our Elegant Leather Handbag –
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="text-gray-700  transition hover:text-gray-700 dark:text-white">
                  Blogs
                </li>
